...
<ScrollView  contentContainerStyle={{flexGrow:1,paddingVertical:getResponsiveFontSize(25)}} style={{marginTop:'5%'}}>
...
{m>0 &&
<LinearGradient  style={{opacity:0.2,borderRadius:getResponsiveFontSize(15),height:getResponsiveFontSize(106),width:`${ (((m/x.montant)*100+7)<100 ? ((m/x.montant)*100+7) : 107)}%`,backgroundColor:'white',position:'absolute',top:"0%",left:"0%",paddingHorizontal:"2%",flex:1,paddingVertical:"3%"}}
